...
import com.samluys.filtertab.listener.OnFilterToBasicDataListener;
...
public class FilterTabView extends LinearLayout implements OnFilterToViewListener {
    ...
    private OnFilterToBasicDataListener onFilterToBasicDataListener;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            btnTextSelect = a.getColor(R.styleable.FilterTabView_btn_text_select_color, mContext.getResources().getColor(R.color.title_select));
            btnTextUnSelect = a.getColor(R.styleable.FilterTabView_btn_text_unselect_color, mContext.getResources().getColor(R.color.title_unselect));
    ...
    public FilterTabView addFilterItem(String tabName, List<BaseFilterBean> data, final int filterType, int popupIndex) {
        ...
        tv_tab_name.setTextColor(Color.parseColor("#00ffffff"));
    ...
    public void setOnFilterToBasicDataListener(OnFilterToBasicDataListener onFilterToBasicDataListener) {
        this.onFilterToBasicDataListener = onFilterToBasicDataListener;
    }
    ...
    public void onFilterToView(FilterResultBean resultBean) {
        ...
        } else if (resultBean.getPopupType() == FilterTabConfig.FILTER_TYPE_MORE_CONDITION) {
            mHasSelected.put(popupIndex, resultBean);
            onSelectResultListener.onSelectResult(resultBean);

        } else if (resultBean.getPopupType() == FilterTabConfig.FILTER_TYPE_SENIOR_MORE_CONDITION) {
            mHasSelected.put(popupIndex, resultBean);
            onSelectResultListener.onSelectResult(resultBean);
        }
