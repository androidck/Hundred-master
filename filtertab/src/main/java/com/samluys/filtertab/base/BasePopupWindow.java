...
public abstract class BasePopupWindow extends PopupWindow {
     ...
     */
    public BasePopupWindow(Context context, List data, int filterType, int position,
    ...
    // 基本资料回调接口
    public OnFilterToBasicDataListener getOnFilterToBasicDataListener() {
        return onFilterToBasicDataListener;
    }
