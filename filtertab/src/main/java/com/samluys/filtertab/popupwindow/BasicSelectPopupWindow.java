...
import com.samluys.filtertab.adapter.BasicSingleAdapter;
 ...
 * 竖直单选样式
 */
public class BasicSelectPopupWindow extends BasePopupWindow {

    private RecyclerView rv_content;
    private BasicSingleAdapter mAdapter;
    private TextView tv_reset, tv_confirm;
    public BasicSelectPopupWindow(Context context, List<BaseFilterBean> data, int filterType, int position, OnFilterToViewListener listener) {
    ...
    public View initView() {
        ...
        mAdapter = new BasicSingleAdapter(getContext(), getData());
