...
public class ShareBrowserActivity extends MyActivity {
    ...
    protected void initData() {
        ...
        if (MyActivity.MODE_DEFAULT != mode) { // sonic mode
            SonicSessionConfig.Builder sessionConfigBuilder = new SonicSessionConfig.Builder();
            sessionConfigBuilder.setSupportLocalServer(true);

            if (MyActivity.MODE_SONIC_WITH_OFFLINE_CACHE == mode) {
                ...
                sessionConfigBuilder.setConnectionInterceptor(new SonicSessionConnectionInterceptor() {
                    ...
                    public SonicSessionConnection getConnection(SonicSession session, Intent intent) {
                        return new OfflinePkgSessionConnection(ShareBrowserActivity.this, session, intent);
                    }
                });
            }
        ...
        // js 方法监听
        webView.addJavascriptInterface(new MyPicJavaScript(getApplicationContext()), "Android"); // JS回调
