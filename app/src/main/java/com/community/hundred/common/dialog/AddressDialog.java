...
import com.community.hundred.common.base.MyRecyclerViewAdapter;
...
public final class AddressDialog {
    ...
    protected static final class AddressDialogAdapter extends MyRecyclerViewAdapter<AddressBean> {
