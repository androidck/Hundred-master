package com.community.hundred.common.ninegridlayout;
...
//        params.width = width;
    ...
    protected abstract void onClickImage(RatioImageView imageView,int position, String url, List<String> urlList);
}
