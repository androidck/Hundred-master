...
import com.community.hundred.common.aop.Permissions;
...
public final class UpdateDialog {
    ...
    public static final class Builder
        ...
        private final AutoRelativeLayout ly_esc;
        ...
        public Builder(Context context) {
            ...
            ly_esc = findViewById(R.id.ly_esc);
        ...
        public Builder setForceUpdate(boolean force) {
            ...
            ly_esc.setVisibility(force ? View.GONE : View.VISIBLE);
            setCancelable(!force);
            return this;
        }
        ...
        private void installApk() {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(getContext(), KeyConstant.provider, mApkFile);
