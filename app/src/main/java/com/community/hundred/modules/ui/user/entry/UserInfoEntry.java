package com.community.hundred.modules.ui.user.entry;
...
public class UserInfoEntry {
     ...
     * last_viewtime :
     * parent : 0
     * invite_code : 20838896
     * record_time : 1579177230
     * status : 1
     * period : 1798970703
     * invite_qrcode :
     * agent : 0
    ...
    private String city;
    private List<UserAlbumEntry> album;
    ...
    public void setSpread_count(String spread_count) {
    ...
    public List<UserAlbumEntry> getAlbum() {
        return album;
    }

    public void setAlbum(List<UserAlbumEntry> album) {
        this.album = album;
    }
}
