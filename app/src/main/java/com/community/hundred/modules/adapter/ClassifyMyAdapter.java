...
// 分类适配器
public class ClassifyMyAdapter extends BaseRecyclerViewAdapter<ClassifyMyAdapter.ViewHolder> {
    ...
    public ClassifyMyAdapter(Context context, List<ClassifyChildEntry> list) {
        super(context);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.img_symbol.setImageResource(R.mipmap.item_jian);
