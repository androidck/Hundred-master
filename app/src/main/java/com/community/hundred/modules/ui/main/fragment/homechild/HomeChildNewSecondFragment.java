...
// 子页面
public class HomeChildNewSecondFragment extends MyLazyFragment<MainActivity, IHomeView, HomePresenter> {
   ...
   /* @BindView(R.id.view_lines)
    ...
    protected int getLayoutId() {
        return R.layout.fragment_child_second_new;
    }
    ...
    public static HomeChildNewSecondFragment getInstance(String id, String menu, String name) {
        HomeChildNewSecondFragment fragment = new HomeChildNewSecondFragment();
