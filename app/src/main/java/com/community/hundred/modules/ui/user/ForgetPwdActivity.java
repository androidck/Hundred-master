...
// 忘记密码
@Route(path = ActivityConstant.FOR_GET_PWD)
public class ForgetPwdActivity extends MyActivity<IRegisterView, RegisterPresenter> implements IRegisterView {
    ...
    @OnClick({R.id.ed_phone, R.id.tv_get_code, R.id.et_code, R.id.ed_pwd, R.id.is_show_pwd, R.id.btn_login, R.id.tv_register, R.id.for_got_pwd, R.id.tv_agreement})
    ...
    public void forGotPwd() {
        mPresenter.forgetPwd(edPhone.getText().toString().trim().replace(" ", ""),
